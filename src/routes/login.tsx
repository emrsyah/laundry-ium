    ...
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-background p-4 pt-12 items-center justify-center">
      ...
      <div className="w-full max-w-sm z-10 animate-in fade-in slide-in-from-bottom-8 duration-700 pb-16">
        <div className="text-center mb-8 space-y-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-foreground">LaundryKu</h1>
        ...
        <Card className="border shadow-lg bg-card/80 backdrop-blur-md rounded-3xl">
          <form onSubmit={handleLogin}>
            <CardHeader className="pb-2 pt-8 text-center">
              <CardTitle className="text-2xl font-bold">Halo Erna! 👋</CardTitle>
              <CardDescription className="text-sm mt-2">Masukkan PIN untuk mulai kasir.</CardDescription>
            </CardHeader>
            ...
            <CardFooter className="px-6 pb-8">
              <Button type="submit" disabled={isLoading} className="w-full h-14 text-lg rounded-2xl font-bold shadow-md active:scale-[0.98] transition-transform">
